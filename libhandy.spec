...
Source0  : https://download.gnome.org/sources/libhandy/1.6/libhandy-1.6.2.tar.xz
...
%prep
%setup -q -n libhandy-1.6.2
cd %{_builddir}/libhandy-1.6.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1650683832
...
cp %{_builddir}/libhandy-1.6.2/COPYING %{buildroot}/usr/share/package-licenses/libhandy/01a6b4bf79aca9b556822601186afab86e8c4fbf
