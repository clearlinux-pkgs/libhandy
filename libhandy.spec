...
Source0  : https://download.gnome.org/sources/libhandy/1.8/libhandy-1.8.2.tar.xz
...
%prep
%setup -q -n libhandy-1.8.2
cd %{_builddir}/libhandy-1.8.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1680038518
