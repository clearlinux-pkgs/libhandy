...
Version  : 1.8.1
Release  : 29
URL      : https://download.gnome.org/sources/libhandy/1.8/libhandy-1.8.1.tar.xz
Source0  : https://download.gnome.org/sources/libhandy/1.8/libhandy-1.8.1.tar.xz
...
%prep
%setup -q -n libhandy-1.8.1
cd %{_builddir}/libhandy-1.8.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1675264907
