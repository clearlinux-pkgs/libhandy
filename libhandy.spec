...
Source0  : https://download.gnome.org/sources/libhandy/1.8/libhandy-1.8.3.tar.xz
...
%prep
%setup -q -n libhandy-1.8.3
cd %{_builddir}/libhandy-1.8.3
pushd ..
cp -a libhandy-1.8.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707496401
