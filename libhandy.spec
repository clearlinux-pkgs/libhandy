...
Version  : 1.3.90
Release  : 15
URL      : https://download.gnome.org/sources/libhandy/1.3/libhandy-1.3.90.tar.xz
Source0  : https://download.gnome.org/sources/libhandy/1.3/libhandy-1.3.90.tar.xz
...
%prep
%setup -q -n libhandy-1.3.90
cd %{_builddir}/libhandy-1.3.90
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1628806590
...
cp %{_builddir}/libhandy-1.3.90/COPYING %{buildroot}/usr/share/package-licenses/libhandy/01a6b4bf79aca9b556822601186afab86e8c4fbf
