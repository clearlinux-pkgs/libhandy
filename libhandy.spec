...
%prep
%setup -q -n libhandy-1.0.0
cd %{_builddir}/libhandy-1.0.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1600270987
...
cp %{_builddir}/libhandy-1.0.0/COPYING %{buildroot}/usr/share/package-licenses/libhandy/01a6b4bf79aca9b556822601186afab86e8c4fbf
