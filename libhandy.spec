...
Source0  : https://source.puri.sm/Librem5/libhandy/-/archive/v0.80.0/libhandy-v0.80.0.tar.gz
...
%prep
%setup -q -n libhandy-v0.80.0
cd %{_builddir}/libhandy-v0.80.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1592329332
...
cp %{_builddir}/libhandy-v0.80.0/COPYING %{buildroot}/usr/share/package-licenses/libhandy/01a6b4bf79aca9b556822601186afab86e8c4fbf
cp %{_builddir}/libhandy-v0.80.0/debian/copyright %{buildroot}/usr/share/package-licenses/libhandy/d295f3a9ec2407b00d9f397ce11fb432ae071dd2
