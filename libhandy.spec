...
Source0  : https://gitlab.gnome.org/GNOME/libhandy/-/archive/1.0.2/libhandy-1.0.2.tar.gz
...
%prep
%setup -q -n libhandy-1.0.2
cd %{_builddir}/libhandy-1.0.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1605462660
...
cp %{_builddir}/libhandy-1.0.2/COPYING %{buildroot}/usr/share/package-licenses/libhandy/01a6b4bf79aca9b556822601186afab86e8c4fbf
