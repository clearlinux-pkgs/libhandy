...
Source0  : https://download.gnome.org/sources/libhandy/1.7/libhandy-1.7.90.tar.xz
...
%prep
%setup -q -n libhandy-1.7.90
cd %{_builddir}/libhandy-1.7.90
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1659968625
