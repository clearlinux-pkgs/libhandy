...
Version  : 1.2.3
Release  : 14
URL      : https://download.gnome.org/sources/libhandy/1.2/libhandy-1.2.3.tar.xz
Source0  : https://download.gnome.org/sources/libhandy/1.2/libhandy-1.2.3.tar.xz
...
%prep
%setup -q -n libhandy-1.2.3
cd %{_builddir}/libhandy-1.2.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1624287578
...
cp %{_builddir}/libhandy-1.2.3/COPYING %{buildroot}/usr/share/package-licenses/libhandy/01a6b4bf79aca9b556822601186afab86e8c4fbf
