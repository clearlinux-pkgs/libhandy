...
Version  : 1.7.0
Release  : 23
URL      : https://download.gnome.org/sources/libhandy/1.7/libhandy-1.7.0.tar.xz
Source0  : https://download.gnome.org/sources/libhandy/1.7/libhandy-1.7.0.tar.xz
...
%prep
%setup -q -n libhandy-1.7.0
cd %{_builddir}/libhandy-1.7.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1657477416
...
cp %{_builddir}/libhandy-1.7.0/COPYING %{buildroot}/usr/share/package-licenses/libhandy/01a6b4bf79aca9b556822601186afab86e8c4fbf
