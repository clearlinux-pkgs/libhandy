...
Source0  : https://gitlab.gnome.org/GNOME/libhandy/-/archive/1.0.1/libhandy-1.0.1.tar.gz
...
%prep
%setup -q -n libhandy-1.0.1
cd %{_builddir}/libhandy-1.0.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1604524811
...
cp %{_builddir}/libhandy-1.0.1/COPYING %{buildroot}/usr/share/package-licenses/libhandy/01a6b4bf79aca9b556822601186afab86e8c4fbf
