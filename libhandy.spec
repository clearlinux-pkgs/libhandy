...
Source0  : https://download.gnome.org/sources/libhandy/1.2/libhandy-1.2.2.tar.xz
...
%prep
%setup -q -n libhandy-1.2.2
cd %{_builddir}/libhandy-1.2.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1619634958
...
cp %{_builddir}/libhandy-1.2.2/COPYING %{buildroot}/usr/share/package-licenses/libhandy/01a6b4bf79aca9b556822601186afab86e8c4fbf
